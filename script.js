function calcularComision() {
    ...
    if (tipoDeProducto === 12) {
        resultado = (((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia))) * 0.90;
    } else if (tipoDeProducto === 24) {
        resultado = ((((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia))) * 2) * 0.90;
    } else if (tipoDeProducto === 36) {
        resultado = ((((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia))) * 3) * 0.90;
    }
